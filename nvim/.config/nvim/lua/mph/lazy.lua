...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'vim', 'c_sharp' },
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>ss', require('telescope.builtin').lsp_document_symbols, '[S]ymbols: Document [S]ymbols')
